                                        ...
                                        item.anyFunction
                                            ...
                                            <MenuItem key={item.title} >
                                                <Typography textAlign="center">
                                                    <NavLink to={item.url} className={classes.avtarStyle} exact="true" onClick={handleLogout}>{item.title}</NavLink>
                                                </Typography>
                                            </MenuItem>
                                            :
                                            <MenuItem key={item.title}>
                            ...
                            {auth
                                ...
                                PAGES_AFTER_AUTH.map((item) => (
                                    item.anyFunction
                                        ...
                                        >
                                            <NavLink to={item.url} className={classes.navItemStyle} exact="true" onClick={handleLogout}>{item.title}</NavLink>
                                        </Button>
                                        :
                                        <Button
                                            key={item.title}
