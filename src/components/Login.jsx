...
import { authUser } from "../services/apis";
...
const AddUser = () => {
    ...
    const submitLogin = async () => {
        ...
        if (res.data.error) {
            ...
            localStorage.setItem('loginData', JSON.stringify(userObj.userData));
            localStorage.setItem('loginToken', JSON.stringify(userObj.token.token));
            console.log("Success😊\nYou are login now.");
            navigate('/profile');
        }
    }
