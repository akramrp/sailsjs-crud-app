                    ...
                    <Card sx={{ margin: 5 }}>
                        ...
                        <CardContent>
                            <Typography gutterBottom variant="h5" component="div">
                                LOGIN SYSTEM | CRUD SYSTEM
                            </Typography>
                            <Typography variant="body2" color="text.secondary">
                                <Box>Welcome, Login Or Register Here for Dashboard view </Box> <br />
                                <Box sx={{ fontWeight: 'bold'}}>Frontend: ReactJS, Material</Box> <br />
                                <Box sx={{ fontWeight: 'bold'}}>Backent: SailsJS</Box> <br />
                            ...
                            <Box
                                ...
                                <div>
                                    <Box>
                                        ...
                                        <Typography variant="h5"> Go To login page and access your control</Typography>
                                        <Typography>
                                            LOREM77::::: &nbsp;&nbsp;
                                            ...
                                            inventore perspiciatis accusamus molestias nam provident eligendi beatae eveniet perferendis commodi sed saepe tempore eius voluptas modi assumenda dignissimos suscipit similique tempora!inventore perspiciatis accusamus molestias nam provident eligendi beatae eveniet perferendis commodi sed saepe tempore eius voluptas modi assumenda dignissimos suscipit similique tempora!
                                            <Typography>
                                            inventore perspiciatis accusamus molestias nam provident eligendi beatae eveniet perferendis commodi sed saepe tempore eius voluptas modi assumenda dignissimos suscipit similique tempora!
                                            </Typography>
                                        </Typography>
                                    </Box>
                                </div>
